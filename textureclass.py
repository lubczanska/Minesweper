...
class Textureclass:
    ...
    def __init__(self, theme):
        ...
        self.buttongame = pygame.image.load(path + "buttongame.gif")
        self.buttongame.convert()
        self.buttonmulti = pygame.image.load(path + "buttonmulti.gif")
        self.buttonmulti.convert()
