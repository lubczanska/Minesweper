...
class Textureclass:
    ...
    def __init__(self, theme):
        ...
        self.bottom_left = pygame.image.load(path + "borderbl.gif")
        self.bottom_left.convert()
        self.bottom_middle = pygame.image.load(path + "bordertb.gif")
        self.bottom_middle.convert()
        self.bottom_right = pygame.image.load(path + "borderbr.gif")
